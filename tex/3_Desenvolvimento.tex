...
Para o desenvolvimento do projeto de \textit{software}, diversas tecnologias foram utilizadas, incluindo linguagens de programação, \textit{frameworks} e ferramentas. Nas seções seguintes, estão descritas cada uma delas.
