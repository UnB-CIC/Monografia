...
\figura[!ht]{../img/figma_course1.png}{Protótipos de telas contendo a \textit{Home} do aplicativo e seleção de Tópicos}{figma_course1}{width=0.75\textwidth}
...
\figura[!ht]{../img/figma_course2.png}{Protótipos de telas contendo a página de tópico com opções para nevegação para os desafios cadastrados e para o ranking}{figma_course2}{width=0.75\textwidth}

\subsection{\textit{Chat}}
...
\figura[!ht]{../img/figma_chat.png}{Protótipos de telas contendo as funções de envio e recebimanto de mensagens no \appName}{figma_chat}{width=0.5\textwidth}
...
\section{\textit{Lucid Charts}}

Ferramenta onde foi desenhado o fluxo de utilização\dots
