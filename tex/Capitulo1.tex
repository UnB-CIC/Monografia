...
texto científico como requisito para formação (veja \refAnexo{NormasGerais}
...
na \refFig{latexvsword}\footnote{Figura obtida de \url{http://www.pinteric.com/miktex.html}.}.

\figura{miktex}{\LaTeX\ vs MS Word}{latexvsword}{width=.45\textwidth}%
